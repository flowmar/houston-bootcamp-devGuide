      ...
      switch (this.props.auth) {
          ...
          default:
            return [
              ...
              <li key="2"><Link to="/workflow" className="btn btn-amber amber darken-3">New Project</Link></li>, 
        ...
        <div className="col-12">
          ...
          <nav id="mainNav" className="navbar">
            <div className="navbar-header">
              <Link 
                to={this.props.auth ? '/workflow' : '/'} className="navbar-brand z-depth-1" style={logoStyle}>
                DevGuide Logo
              </Link>
            </div>
