...
class Navbar extends Component {
   renderContent() {
      switch (this.props.auth) {
          ...
          default:
            return [
              <li key="1"><Button className="btn btn-cyan z-depth-3" text="About Us"/></li>,
              <li key="2"><Link to="/project" className="btn btn-amber amber darken-3 z-depth-3">New Project</Link></li>,
              <li key="3"><Button className="btn btn-amber amber darken-5 z-depth-3" href="/api/logout" text="Logout"/></li>
            ];
      }
    }
      ...
      <div className="row z-depth-5 animated slideInDown mb-2">
          ...
          <nav id="mainNav" className="navbar col indigo darken-4">
            <div className="navbar-header">
              <Link
                to={this.props.auth ? '/project' : '/'} className="navbar-brand" style={logoStyle}>
